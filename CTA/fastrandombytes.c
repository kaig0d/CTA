...
/* we put the input string in one part of the block, and the counter in the other part */
...
// static const __m128i IV_Mat4 = {0, 0x4D617434};
...
static inline void fastrandombytes_setseed(__m128i *round_key, const unsigned char *randomness)
{
...
// void fastrandombytes_setiv_mat4()
// {
// 	iv_pub = IV_Mat4;
// }

static inline void AES_ctr_round(__m128i *round_key, __m128i *iv, unsigned char *out)
{
	__m128i tmp;
...
static inline void fastrandombytes(__m128i *round_key, __m128i *iv, unsigned char *r, unsigned long long rlen)
{
	unsigned char ct[16];
